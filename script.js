...
let t = 0; //Initialize t for clearTimeout
...
guyPosition = (origin) => {
    ...
    if (origin === 1) { //If origin is on the left side...
        ...
        eyeCoefficient = Math.ceil(((rotateZ / 1.7) - 18.47)); //...set eyeCoefficient as a function of z rotation bewteen 8 and 52. 8 and 61
    ...
    if (origin === 2) { //If origin is at the top...
        ...
        eyeCoefficient = Math.ceil((((rotateZ - 90) / 1.7) - 18.47)); //...set eyeCoefficient as a function of z rotation bewteen 8 and 52.
